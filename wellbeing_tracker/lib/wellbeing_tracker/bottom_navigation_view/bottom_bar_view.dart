                  ...
                  child: ScaleTransition(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: <BoxShadow>[
                          BoxShadow(
                              color: FitnessAppTheme.nearlyDarkBlue.withAlpha((0.4 * 255).toInt()),
...
class TabIconsState extends State<TabIcons> with TickerProviderStateMixin {
  ...
  @override
  Widget build(BuildContext context) {
    final isHistoryIcon = widget.tabIconData?.imagePath == 'icon:history';
    return AspectRatio(
      aspectRatio: 1,
      child: Center(
        child: InkWell(
                  ...
                  child: isHistoryIcon
                      ? Icon(
                          ...
                          color: widget.tabIconData!.isSelected
                              ? FitnessAppTheme.nearlyDarkBlue
                              : FitnessAppTheme.grey.withAlpha((0.6 * 255).toInt()), // fixed deprecated withOpacity
                        )
