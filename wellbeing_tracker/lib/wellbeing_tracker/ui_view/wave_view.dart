        ...
        builder: (context, child) => Stack(
          children: <Widget>[
                ...
                decoration: BoxDecoration(
                  color: FitnessAppTheme.nearlyDarkBlue.withAlpha((0.5 * 255).toInt()),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      FitnessAppTheme.nearlyDarkBlue.withAlpha((0.2 * 255).toInt()),
                      FitnessAppTheme.nearlyDarkBlue.withAlpha((0.5 * 255).toInt())
                    ],
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: [
                      FitnessAppTheme.nearlyDarkBlue.withAlpha((0.4 * 255).toInt()),
            ...
            Positioned(
              ...
              child: ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: FitnessAppTheme.white.withAlpha((0.4 * 255).toInt()),
            ...
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1,
                  child: Image.asset("assets/wellbeing_tracker/bottle.png"),
                ),
              ],
            )
          ],
