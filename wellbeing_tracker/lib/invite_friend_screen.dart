          ...
          body: Column(
            children: <Widget>[
              ...
              Container(
                ...
                child: Text(
                  'A step together towards better health!',
                    ...
                    child: Container(
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          onTap: () {
                            Share.share(
                              'Check out the Wellbeing Tracker app! Download it now to track your health and habits.',
                              subject: 'Join me on Wellbeing Tracker!',
                            );
                          },
                          child: Center(
                            child: Row(
